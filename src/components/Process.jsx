...
const steps = [
  { num: '01', title: 'Погружение', desc: 'Знакомство с художником дня — его идеями, приёмами и историей', color: '#729ACD', bg: 'rgba(114,154,205,0.13)', rotate: '-2deg' },
  { num: '02', title: 'Диалог', desc: 'Обсуждение работ: каждый высказывается, каждое мнение ценно', color: '#E56787', bg: 'rgba(229,103,135,0.13)', rotate: '1.5deg' },
  { num: '03', title: 'Практика', desc: 'Акварель, акрил, коллаж, инсталляция — свобода выбора', color: '#F18C1F', bg: 'rgba(241,140,31,0.13)', rotate: '-1deg' },
  { num: '04', title: 'Команда', desc: 'Активные игры и совместные проекты', color: '#B4B534', bg: 'rgba(180,181,52,0.13)', rotate: '2deg' },
  { num: '05', title: 'Выставка', desc: 'Каждый день — шаг к финальной экспозиции авторских работ', color: '#c8a800', bg: 'rgba(245,220,144,0.30)', rotate: '-1.5deg' },
];
...
export default function Process() {
  ...
  return (
    <section id="process" className="py-24 md:py-32 px-6 md:px-14" style={{ background: '#F8F8F8' }}>
          ...
          <div className="hidden md:flex items-start gap-2">
            {steps.map((step, i) => (
              <div key={i} className="flex items-start gap-2 flex-1">
                <div
                  className="rounded-2xl p-5 flex-1 border-2 relative overflow-hidden"
                  style={{
                    background: step.bg,
