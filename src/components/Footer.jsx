export default function Footer() {
  return (
    <footer id="contacts" className="py-12 md:py-20 px-6 md:px-14 border-t border-border">
      <div className="max-w-5xl mx-auto text-center">
        <div>
          <p className="text-sm font-semibold tracking-[0.3em] uppercase text-blue mb-4">
            Контакты
          </p>
          <div className="w-16 h-px bg-blue mx-auto mb-6" />
          ...
          <a
            ...
            className="btn-sticker bg-blue text-white px-7 py-3.5 tracking-wide text-sm inline-flex"
          >
        ...
        <div className="mt-10 md:mt-16 pt-8 border-t border-border">
          <p className="font-playfair text-base md:text-xl text-muted-foreground italic">
