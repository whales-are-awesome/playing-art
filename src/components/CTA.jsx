...
export default function CTA() {
  ...
  return (
    <section id="pricing" className="py-16 md:py-24 px-6 md:px-14">
      <div ref={ref} className="reveal max-w-4xl mx-auto rounded-3xl px-6 md:px-16 py-12 md:py-20 text-center relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground text-sm md:text-base mb-8 leading-relaxed">
            15–26 июня · Ереван<br className="sm:hidden" /> · 10:00–14:00 · дети 7–13 лет
          </p>
          ...
          <a
            ...
            className="btn-sticker text-white px-8 py-3.5 md:px-10 md:py-4 text-sm md:text-base tracking-wide"
